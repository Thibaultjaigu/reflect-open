...
export function captureFixture(): XPost {
  return {
    ...
    body: [{ type: 'text', text: '中文 and emoji 🌱' },
      { type: 'link', text: ' example', url: 'https://example.com/' }],
    media: [
      { type: 'photo', url: 'https://pbs.twimg.com/photo.jpg', width: 10, height: 10 },
      { type: 'video', width: 10, height: 10, poster: 'https://pbs.twimg.com/poster.jpg', sources: [
    ...
    quote: {
      id: '21', createdAt: '2026-09-13T00:00:00.000Z',
      author: { name: 'Quoted', handle: 'quoted' },
      body: [{ type: 'text', text: 'Quoted text' }], truncated: true,
      media: [{ type: 'gif', width: 10, height: 10, unavailable: true,
        poster: 'https://pbs.twimg.com/quote.jpg', sources: [
          { type: 'application/x-mpegURL', url: 'https://video.twimg.com/quote.m3u8' },
        ] }],
    },
  }
}
